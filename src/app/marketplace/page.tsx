...
// ── SSO Buy Now ─────────────────────────────────────────────────────────────
// Generates a CampusKartt session for the current EcoXchange user then
// redirects straight to the listing page — no sign-in required on CampusKartt.
              ...
              {filtered.map((listing) => {
                ...
                return isCK ? (
                  ...
                  >
                    ...
                    {/* Metrics — matches native card exactly */}
                    ...
                    {/* History row — matches native card */}
